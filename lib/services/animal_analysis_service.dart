...
class AnimalAnalysisService {
  ...
  double? get ageAtFirstCalving {
    ...
    return firstCalving.date.difference(animal.dataNascimento).inDays / 30.44;
  }
  ...
  double? get adgBirthToWeaning {
    ...
    final birthWeightRecord = animal.historicoPeso
        .sortedBy((r) => r.date.difference(animal.dataNascimento).abs())
        .firstOrNull;
    final weanWeightRecord = animal.historicoPeso
        .sortedBy((r) => r.date.difference(animal.dataDesmame!).abs())
        .firstOrNull;
