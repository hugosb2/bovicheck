...
import '../servicos/spreadsheet_service.dart';
import '../componentes/ai_analysis_card.dart';
import '../componentes/app_drawer.dart';
    ...
    final actions = [
      {
        'icon': AppIcons.add,
        'label': 'Novo Animal',
        'action': () => _onAddNewAnimalPressed(context, controller)
      },
      {
        'icon': AppIcons.herd,
        'label': 'Meu Rebanho',
        'action': () => _navigateTo(context, '/animals', controller)
      },
      {
        'icon': AppIcons.lotes,
        'label': 'Gerenciar Lotes',
        'action': () => _navigateTo(context, '/lotes', controller)
      },
      {
        'icon': AppIcons.properties,
        'label': 'Propriedades',
        'action': () =>
            _navigateTo(context, '/settings/propriedades', controller)
      },
      {
        'icon': AppIcons.indicators,
        'label': 'Indicadores',
        'action': () => _navigateTo(context, '/herd-indicators', controller)
      },
      {
        'icon': AppIcons.exportExcel,
        'label': 'Exportar Planilha',
        'action': () => _onExportPressed(context)
      },
      {
        'icon': AppIcons.settings,
        'label': 'Configurações',
        'action': () => _navigateTo(context, '/settings', controller)
      },
    ];
    ...
    return Card(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            _buildSummaryItem(
                    context, AppIcons.herd, animalCount.toString(), 'Animais')
                .animate()
                .fadeIn(duration: 300.ms, delay: 100.ms)
                .scale(begin: const Offset(0.8, 0.8), end: const Offset(1, 1)),
            _buildSummaryItem(
                    context, AppIcons.lotes, loteCount.toString(), 'Lotes')
                .animate()
                .fadeIn(duration: 300.ms, delay: 200.ms)
                .scale(begin: const Offset(0.8, 0.8), end: const Offset(1, 1)),
            _buildSummaryItem(context, AppIcons.properties,
                    propCount.toString(), 'Propriedades')
                .animate()
