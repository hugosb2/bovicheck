...
import 'package:bovicheck/telas/lotes/lote_detail_view.dart';
import 'package:flutter/material.dart';
import 'package:flutter_animate/flutter_animate.dart';

class TelaDetalhePropriedade extends StatefulWidget {
  final String propriedadeId;
  const TelaDetalhePropriedade({super.key, required this.propriedadeId});

  @override
  State<TelaDetalhePropriedade> createState() => _TelaDetalhePropriedadeState();
}

class _TelaDetalhePropriedadeState extends State<TelaDetalhePropriedade> {
                  ...
                  _buildInfoCard(
                    ...
                    children: [
                      _buildInfoTile(context,
                          title: 'ID', value: _propriedade!.id),
                      _buildInfoTile(context,
                          title: 'Proprietário',
                          value: _propriedade!.proprietario),
                      _buildInfoTile(context,
                          title: 'Município', value: _propriedade!.municipio),
                      _buildInfoTile(context,
                          title: 'Estado', value: _propriedade!.estado),
                      _buildInfoTile(context,
                          title: 'Área Total',
                          value:
                              '${_propriedade!.areaTotal.toStringAsFixed(2)} ha'),
                    ],
                  ),
...
class PropriedadeDetailView extends TelaDetalhePropriedade {
  const PropriedadeDetailView({super.key, required super.propriedadeId})
      : super();
}
